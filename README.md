...
3. Once you have your colors selected, **3x click** (any multiclick) to randomize balloon health
  </br> a) At any point in the game, **3x click** restarts the game by going back to Setup Phase and re-randomizes balloon health
4. Each player **long presses** one (or more if long pressed simultaneously) of their balloons/Blinks to set it as their King Balloon
